...
class _TransactionsPageState extends State<TransactionsPage> {
  ...
  Future<List<Transaction>> fetchTransactions() async {
    ...
    final url =
        'http://${localhostInstance.ipServer}/dashboard/myfolder/getTransactions.php'; // Replace with your server URL
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                _buildDetailRow(
                    'Transaction ID:', transaction.par_id.toString()),
                ...
                if (transaction.purpose != null &&
                    transaction.purpose!.isNotEmpty)
