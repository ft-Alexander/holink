...
class _CancellationInformationState extends State<CancellationInformation> {
  ...
  Future<void> _submitCancellation() async {
    if (_formKey.currentState!.validate()) {
      final url = Uri.parse('http://${localhostInstance.ipServer}/dashboard/myfolder/service/removeAvailedService.php');
                    ...
                    Card(
                      child: ListTile(
                        ...
                        subtitle: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Date Availed: ${serviceDetails?["date_availed"] ?? 'N/A'}"),
                            Text("Scheduled Date: ${serviceDetails?["scheduled_date"] ?? 'N/A'}"),
                          ],
                        ),
                      ),
                    ),
